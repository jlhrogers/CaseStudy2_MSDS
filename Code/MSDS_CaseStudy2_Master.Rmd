---
title: "Procrastination Tendencies of Company Corp. Customers"
date: "November 29, 2017"
output:
  html_document:
    keep_md: true
authors: Jose Torres and Lisa Street
---
...
```{r Question3_HDI_table_scrape_from_Wikipedia}
...
```{r Question4_Preliminary_Analysis, warning=FALSE}
...
```{r Question4_Preliminary_Analysis2, warning=FALSE,echo=TRUE}
...
```{r Question4_Preliminary_Analysis3, warning=FALSE,echo=TRUE}
...
```{r Question5_Preliminary_Analysis,echo=TRUE}
